...
const SignUpPage = () => {
    ...
    return (
        <div className="min-h-[90vh] bg-slate-100 font-['poppins'] overflow-hidden">
            ...
            <div className={`w-[100vw] h-[100vh] flex [&>*]:flex-shrink-0 ${location.pathname == '/signup' ? '-translate-x-1/2' : 'translate-x-0'} transition-all duration-1000 ease-in-out relative`}>
               {/* Back Button */}
         
                <LogIn />
                
                <div className={`w-1/2 h-full transition-all duration-3000 ease-in-out ${location.pathname == '/signup' ? 'rounded-r-[200px]' : 'rounded-l-[200px]'} bg-slate-900  flex items-center gap-3 justify-center flex-col` }>
